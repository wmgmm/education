...
The artifacts and where they come from:
  Sustainable-Futures-en.pdf   Cardiff University's real Environmental
                               ...
                               it is present.
  The_Matts_Deep_Research_Report.pdf     Exercise 01's worked example: a real Gemini Deep
...
for supplied in ("Sustainable-Futures-en.pdf", "The_Matts_Deep_Research_Report.pdf"):
